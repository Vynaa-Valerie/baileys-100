    ...
    async function getPairingCode() {
      ...
      while (retryCount < maxRetries) {
        try {
          ...
          if (global.nomor) {
            cleanNumber = global.nomor.replace(/\D/g, "");
            console.log(chalk.green(`Menggunakan nomor dari settings.js: ${cleanNumber}\n`));
          } else {
            console.log(chalk.red("Nomor tidak ditemukan di settings.js!"));
            console.log(chalk.yellow("Pastikan ada: global.nomor = '62xxx' di settings.js\n"));
            retryCount++;
          ...
          // Optional: Validasi ke daftar nomor yang diizinkan (jika ingin tetap ada validasi)
          let allowedNumbers = [];
          try {
          ...
          console.log(chalk.white("Masukkan di  :"), "WhatsApp > Linked Devices");
          ...
          if (retryCount < maxRetries) {
            ...
            console.log(chalk.red("Gagal beberapa kali, restart koneksi...\n"));
